...
const mockAgentSteps: Omit<AgentStep, "duration" | "id">[] = [
  ...
  },
  {
    ...
    status: "completed",
    details:
      "Fraud score calculated. Multiple data sources consulted including transaction history and behavioral patterns.",
  },
  {
    ...
    status: "completed",
    details:
      "AML checks passed. Customer KYC status verified. No sanctions list matches found.",
  },
  {
    ...
    status: "completed",
    details:
      "Account active and in good standing. Sufficient balance confirmed for transaction.",
  },
  {
    name: "Final Decision",
    ...
    status: "completed",
    details:
      "Decision matrix applied based on risk score, amount, and compliance status.",
  },
];
...
function generateMockResponse(request: DecisionRequest): DecisionResponse {
  ...
  if (request.amount > 10000) {
    ...
    reasons = [
      ...
      "Manual review required for high-value transactions",
    ];
